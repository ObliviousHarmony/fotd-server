...
using FOMServer.Shared.Interop.FOMNetwork.Structs.World;
...
namespace FOMServer.Shared.Interop.FOMNetwork.Packets
{
    ...
    public struct WorldObjectsPacket
    {
        ...
        [FieldOffset(9)]
        public WorldObjectInterop Object;

        [FieldOffset(9)]
        public WorldServiceInterop Service;

        [FieldOffset(9)]
        public WorldServiceControlInterop Control;
