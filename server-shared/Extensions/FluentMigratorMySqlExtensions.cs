...
namespace FOMServer.Shared.Extensions
{
    internal static class FluentMigratorMySqlExtensions
    {
        ...
        public static ICreateTableColumnOptionOrWithColumnSyntax AsTinyText(this ICreateTableColumnAsTypeSyntax column)
        {
            return column.AsCustom("TINYTEXT");
        }

        public static ICreateTableColumnOptionOrWithColumnSyntax AsText(this ICreateTableColumnAsTypeSyntax column)
        {
        ...
        public static ICreateTableColumnOptionOrWithColumnSyntax AsLongText(this ICreateTableColumnAsTypeSyntax column)
        {
        ...
        public static ICreateTableColumnOptionOrWithColumnSyntax AsTimestamp(this ICreateTableColumnAsTypeSyntax column)
        {
            return column.AsCustom("TIMESTAMP");
        }

        public static ICreateTableWithColumnSyntax AsCreatedAtTimestamp(this ICreateTableColumnAsTypeSyntax column)
        {
            return column.AsCustom("TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP");
        }

        public static ICreateTableWithColumnSyntax AsUpdatedAtTimestamp(this ICreateTableColumnAsTypeSyntax column)
        {
        ...
        public static ICreateTableColumnOptionOrWithColumnSyntax AsUInt8(this ICreateTableColumnAsTypeSyntax column)
        {
            return column.AsCustom("TINYINT UNSIGNED");
        }

        public static ICreateTableColumnOptionOrWithColumnSyntax AsUInt16(this ICreateTableColumnAsTypeSyntax column)
        {
            return column.AsCustom("SMALLINT UNSIGNED");
        }

        public static ICreateTableColumnOptionOrWithColumnSyntax AsUInt32(this ICreateTableColumnAsTypeSyntax column)
        {
            return column.AsCustom("INT UNSIGNED");
        }

        public static ICreateTableColumnOptionOrWithColumnSyntax AsUInt64(this ICreateTableColumnAsTypeSyntax column)
        {
