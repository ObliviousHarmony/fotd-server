 ...
 * @param maxClients The maximum number of clients that can connect to the server.
 * @return A pointer to the initialized interface, or null on failure.
 */
FOM_API FOMNetworkPeer* FOMNetwork_Server_Startup(uint16_t port, uint32_t maxClients);
