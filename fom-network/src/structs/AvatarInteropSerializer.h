...
class AvatarInteropSerializer : protected InteropTypeSerializer<AvatarInterop> {
 public:
  void Write(RakNet::BitStream& bs, const AvatarInterop& data) const {
    bs.Write(data.sex == 1);
  ...
  bool Read(RakNet::BitStream& bs, AvatarInterop& data) const {
