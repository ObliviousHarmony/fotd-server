...
void WorldUpdateInteropSerializer::Write(RakNet::BitStream& bs,
                                         const WorldUpdateInterop& data) const {
  bs.WriteCompressed(data.kind);

  switch (data.kind) {
    case WORLD_UPDATE_TYPE_PLAYER:
      WritePlayer(bs, data.player);
      break;
    case WORLD_UPDATE_TYPE_CHARACTER:
      WriteCharacter(bs, data.character);
      break;
  }
}

bool WorldUpdateInteropSerializer::Read(RakNet::BitStream& bs,
                                        WorldUpdateInterop& data) const {
...
void WorldUpdateInteropSerializer::WritePlayer(
    RakNet::BitStream& bs, const WorldUpdateInterop::PlayerUpdate& data) const {
...
bool WorldUpdateInteropSerializer::ReadPlayer(
    RakNet::BitStream& bs, WorldUpdateInterop::PlayerUpdate& data) const {
...
void WorldUpdateInteropSerializer::WriteCharacter(
    RakNet::BitStream& bs,
...
bool WorldUpdateInteropSerializer::ReadCharacter(
