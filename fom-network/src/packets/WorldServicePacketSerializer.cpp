...
bool WorldServicePacketSerializer::Read(RakNet::BitStream& bs,
                                        WorldServicePacket* data) const {
  ItemListInteropSerializer itemListSerializer;
  FactionEmblemInteropSerializer factionEmblemSerializer;

  uint8_t temp8 = 0;
  uint32_t temp32 = 0;
  uint8_t tempStr[32];
  tempStr[0] = '\0';
  FactionEmblemInterop tempEmblem;
  uint16_t temp16 = 0;
...
void WorldServicePacketSerializer::Write(RakNet::BitStream& bs,
                                         const WorldServicePacket* data) const {
  ItemListInteropSerializer itemListSerializer;
  FactionEmblemInteropSerializer factionEmblemSerializer;
