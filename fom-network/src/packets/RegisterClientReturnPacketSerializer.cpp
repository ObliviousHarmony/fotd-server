...
#include "../structs/PositionRotationInteropSerializer.h"
#include "../structs/faction/FactionEmblemInteropSerializer.h"
#include "../structs/faction/FactionPerksInteropSerializer.h"
#include "../structs/item/ItemInteropSerializer.h"
#include "../structs/item/ItemListInteropSerializer.h"
#include "../structs/player/PlayerAttributesInteropSerializer.h"
#include "../structs/player/PlayerProfileInteropSerializer.h"
#include "../structs/player/PlayerSkillsInteropSerializer.h"
#include "PacketSerializers.h"

namespace FOMNetwork {

void RegisterClientReturnPacketSerializer::Write(
    RakNet::BitStream& bs, const RegisterClientReturnPacket* data) const {
  ItemListInteropSerializer itemListSerializer;
  ItemInteropSerializer itemSerializer;
  AvatarInteropSerializer avatarSerializer;
  PlayerAttributesInteropSerializer attributesSerializer;
  PositionRotationInteropSerializer positionSerializer;
  PlayerProfileInteropSerializer profileSerializer;
  FactionEmblemInteropSerializer emblemSerializer;
  PlayerSkillsInteropSerializer skillsSerializer;
  FactionPerksInteropSerializer perksSerializer;
  ...
  if (avatarCacheCount > MAX_AVATAR_CACHE) avatarCacheCount = MAX_AVATAR_CACHE;
